...
using namespace eosio::internal_use_do_not_use;
...
#ifdef TEST_SHARED_TABLE
   #define db_store_i64                   shared_db_store_i64
   #define db_next_i64                    shared_db_next_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_next_i64                    shared_db_next_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_next_i64                    shared_db_next_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_previous_i64                shared_db_previous_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_previous_i64                shared_db_previous_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_previous_i64                shared_db_previous_i64
   ...
   #define db_previous_i64                shared_db_previous_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_remove_i64                  shared_db_remove_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_get_i64                     shared_db_get_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_update_i64                  shared_db_update_i64
   #define db_get_i64                     shared_db_get_i64
   #define db_store_i64                   shared_db_store_i64
   #define db_lowerbound_i64              shared_db_lowerbound_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_lowerbound_i64              shared_db_lowerbound_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_lowerbound_i64              shared_db_lowerbound_i64
   ...
   #define db_find_i64                    shared_db_find_i64
   #define db_lowerbound_i64              shared_db_lowerbound_i64
   #define db_upperbound_i64              shared_db_upperbound_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_upperbound_i64              shared_db_upperbound_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_upperbound_i64              shared_db_upperbound_i64
   #define db_find_i64                    shared_db_find_i64
   #define db_upperbound_i64              shared_db_upperbound_i64
   #define db_idx64_store                 shared_db_idx64_store
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_next                  shared_db_idx64_next
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_next                  shared_db_idx64_next
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_next                  shared_db_idx64_next
   ...
   #define db_idx64_next                  shared_db_idx64_next
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_previous              shared_db_idx64_previous
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_previous              shared_db_idx64_previous
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_previous              shared_db_idx64_previous
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_previous              shared_db_idx64_previous
   #define db_idx64_find_secondary        shared_db_idx64_find_secondary
   #define db_idx64_store                 shared_db_idx64_store
   #define db_idx64_update                shared_db_idx64_update
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_remove                shared_db_idx64_remove
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_lowerbound            shared_db_idx64_lowerbound
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_lowerbound            shared_db_idx64_lowerbound
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_lowerbound            shared_db_idx64_lowerbound
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_lowerbound            shared_db_idx64_lowerbound
   #define db_idx64_upperbound            shared_db_idx64_upperbound
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_upperbound            shared_db_idx64_upperbound
   #define db_idx64_find_primary          shared_db_idx64_find_primary
   #define db_idx64_upperbound            shared_db_idx64_upperbound
   ...
   #define db_update_i64                  shared_db_update_i64
   #define db_get_i64                     shared_db_get_i64
   #define db_idx_double_store            shared_db_idx_double_store
   #define db_idx_double_find_primary     shared_db_idx_double_find_primary
   #define db_idx_double_update           shared_db_idx_double_update
   #define db_idx_double_store            shared_db_idx_double_store
   #define db_idx_double_find_secondary   shared_db_idx_double_find_secondary
   #define db_idx_double_lowerbound       shared_db_idx_double_lowerbound
   #define db_idx_double_upperbound       shared_db_idx_double_upperbound
   #define db_idx256_store                shared_db_idx256_store
   #define db_idx256_find_primary         shared_db_idx256_find_primary
#endif
