#!/bin/bash
set -eo pipefail
# The purpose of this test is to ensure that the output of the "gaxnod --version" command matches the version string defined by our CMake files
...
# get gaxnod version
ACTUAL=$($BUILD_ROOT/bin/gaxnod --version)
EXIT_CODE=$?
