...
const std::vector<const char*> genesis_intrinsics = {
   ...
   "shared_db_get_i64",
   "shared_db_next_i64",
   "shared_db_previous_i64",
   "shared_db_find_i64",
   "shared_db_lowerbound_i64",
   "shared_db_upperbound_i64",
   "shared_db_end_i64",
   "shared_db_idx64_store",
   "shared_db_idx64_remove",
   "shared_db_idx64_update",
   "shared_db_idx64_find_primary",
   "shared_db_idx64_find_secondary",
   "shared_db_idx64_lowerbound",
   "shared_db_idx64_upperbound",
   "shared_db_idx64_end",
   "shared_db_idx64_next",
   "shared_db_idx64_previous",
   "shared_db_idx128_store",
   "shared_db_idx128_remove",
   "shared_db_idx128_update",
   "shared_db_idx128_find_primary",
   "shared_db_idx128_find_secondary",
   "shared_db_idx128_lowerbound",
   "shared_db_idx128_upperbound",
   "shared_db_idx128_end",
   "shared_db_idx128_next",
   "shared_db_idx128_previous",
   "shared_db_idx_double_store",
   "shared_db_idx_double_remove",
   "shared_db_idx_double_update",
   "shared_db_idx_double_find_primary",
   "shared_db_idx_double_find_secondary",
   "shared_db_idx_double_lowerbound",
   "shared_db_idx_double_upperbound",
   "shared_db_idx_double_end",
   "shared_db_idx_double_next",
   "shared_db_idx_double_previous",
   "shared_db_idx_long_double_store",
   "shared_db_idx_long_double_remove",
   "shared_db_idx_long_double_update",
   "shared_db_idx_long_double_find_primary",
   "shared_db_idx_long_double_find_secondary",
   "shared_db_idx_long_double_lowerbound",
   "shared_db_idx_long_double_upperbound",
   "shared_db_idx_long_double_end",
   "shared_db_idx_long_double_next",
   "shared_db_idx_long_double_previous",
   "shared_db_idx256_store",
   "shared_db_idx256_remove",
   "shared_db_idx256_update",
   "shared_db_idx256_find_primary",
   "shared_db_idx256_find_secondary",
   "shared_db_idx256_lowerbound",
   "shared_db_idx256_upperbound",
   "shared_db_idx256_end",
   "shared_db_idx256_next",
   "shared_db_idx256_previous"
};
