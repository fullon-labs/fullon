...
inline constexpr auto get_intrinsic_table() {
   return detail::generate_table(
      ...
      "env.shared_db_get_i64",
      "env.shared_db_next_i64",
      "env.shared_db_previous_i64",
      "env.shared_db_find_i64",
      "env.shared_db_lowerbound_i64",
      "env.shared_db_upperbound_i64",
      "env.shared_db_end_i64",
      "env.shared_db_idx64_store",
      "env.shared_db_idx64_remove",
      "env.shared_db_idx64_update",
      "env.shared_db_idx64_find_primary",
      "env.shared_db_idx64_find_secondary",
      "env.shared_db_idx64_lowerbound",
      "env.shared_db_idx64_upperbound",
      "env.shared_db_idx64_end",
      "env.shared_db_idx64_next",
      "env.shared_db_idx64_previous",
      "env.shared_db_idx128_store",
      "env.shared_db_idx128_remove",
      "env.shared_db_idx128_update",
      "env.shared_db_idx128_find_primary",
      "env.shared_db_idx128_find_secondary",
      "env.shared_db_idx128_lowerbound",
      "env.shared_db_idx128_upperbound",
      "env.shared_db_idx128_end",
      "env.shared_db_idx128_next",
      "env.shared_db_idx128_previous",
      "env.shared_db_idx_double_store",
      "env.shared_db_idx_double_remove",
      "env.shared_db_idx_double_update",
      "env.shared_db_idx_double_find_primary",
      "env.shared_db_idx_double_find_secondary",
      "env.shared_db_idx_double_lowerbound",
      "env.shared_db_idx_double_upperbound",
      "env.shared_db_idx_double_end",
      "env.shared_db_idx_double_next",
      "env.shared_db_idx_double_previous",
      "env.shared_db_idx_long_double_store",
      "env.shared_db_idx_long_double_remove",
      "env.shared_db_idx_long_double_update",
      "env.shared_db_idx_long_double_find_primary",
      "env.shared_db_idx_long_double_find_secondary",
      "env.shared_db_idx_long_double_lowerbound",
      "env.shared_db_idx_long_double_upperbound",
      "env.shared_db_idx_long_double_end",
      "env.shared_db_idx_long_double_next",
      "env.shared_db_idx_long_double_previous",
      "env.shared_db_idx256_store",
      "env.shared_db_idx256_remove",
      "env.shared_db_idx256_update",
      "env.shared_db_idx256_find_primary",
      "env.shared_db_idx256_find_secondary",
      "env.shared_db_idx256_lowerbound",
      "env.shared_db_idx256_upperbound",
      "env.shared_db_idx256_end",
      "env.shared_db_idx256_next",
      "env.shared_db_idx256_previous"
   );
}
