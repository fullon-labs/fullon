...
const static uint32_t   default_max_block_net_usage                  = 2 * 1024 * 1024; /// at 1000ms blocks and 200byte trx, this enables ~10,000 TPS burst
...
const static uint32_t   default_net_usage_leeway                     = 1000; // TODO: is this reasonable?
...
const static uint32_t   shared_contract_bytes_multiplier   = 2;     ///< multiplier on shared contract data size for multiple copies and cached compilation
